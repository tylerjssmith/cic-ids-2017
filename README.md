...
For bots and web attacks, the model had excellent recall (0.9872 and 0.9679, respectively) but poor or moderate precision (0.0325 and 0.6563, respectively). These types of attacks are difficult to distinguish using network flows (Layer 4 data) and would be better detected with application data (Layer 7 data). A SQL injection attack, for example, would appear legitimate at Layer 4 but be detected at Layer 7.
