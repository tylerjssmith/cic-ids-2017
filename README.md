...
The trained models in the .pkl file are evaluated on test data. **Note: The `results.pkl` and `final.skops` files mentioned below can be obtained by decompressing [models/examples.zip](models/examples.zip). These were compressed due to GitHub file size limits.
